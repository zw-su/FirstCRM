...
class CustomerInfo(models.Model):
    ...
    consult_courses = models.ManyToManyField('Course', name='咨询课程')
    consult_content = models.TextField(verbose_name='咨询内容')
    status_choices = (0, '未报名'), (1, '已报名'), (2, '已退学')
    id_num = models.CharField(max_length=32, blank=True, null=True, verbose_name='身份证')
...
class CustomerFollowUp(models.Model):
    """ 客户跟踪记录表 """
    customer = models.ForeignKey('CustomerInfo')#ForeignKey在的位置是多,'CustomerInfo'是一
